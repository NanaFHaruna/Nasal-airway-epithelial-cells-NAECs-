...
<h2>Description</h2>
This project consists of the scripts used in the analysis in this research paper. The data consisted of 9 scRNA-seq data sets obtained from sequencing nasal airway epithelial cells from children aged 2-3 years from four mutually exclusive groups of wheezers/non-wheezers and RSV-infected/uninfected in the first year of life. The data was sequenced on 10x Genomics, and the raw sequencing data was processed using the CellRanger pipeline. Detailed in the scripts are the methods of integration and downstream analysis to generate figures and data used in the research paper. 
